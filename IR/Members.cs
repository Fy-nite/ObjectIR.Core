...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class FieldDefinition
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class PropertyDefinition
{
   public string Name { get; set; }
   public TypeReference Type { get; set; }
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class EnumMember
{
   public string Name { get; set; }
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class GenericParameter
{
   public string Name { get; set; }
...
// TODO: implement typeConstraints into main AST module system.
[Obsolete("Use ASTNode equivalents instead.")]public sealed class ClassConstraint : TypeConstraint { }
[Obsolete("Use ASTNode equivalents instead.")]public sealed class StructConstraint : TypeConstraint { }
[Obsolete("Use ASTNode equivalents instead.")]public sealed class BaseTypeConstraint : TypeConstraint
{
