...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class MethodDefinition
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class FunctionDefinition
{
   public string Name { get; set; }
   public TypeReference ReturnType { get; set; }
   public List<Parameter> Parameters { get; } = new();
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class LocalVariable
{
   public string Name { get; set; }
   public TypeReference Type { get; set; }
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class MethodReference
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class FieldReference
{
   public TypeReference DeclaringType { get; }
   public string Name { get; }
