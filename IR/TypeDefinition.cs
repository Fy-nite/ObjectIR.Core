...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class ClassDefinition : TypeDefinition
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class InterfaceDefinition : TypeDefinition
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class StructDefinition : TypeDefinition
{
   public List<TypeReference> Interfaces { get; } = new();
   public List<FieldDefinition> Fields { get; } = new();
   public List<MethodDefinition> Methods { get; } = new();
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class EnumDefinition : TypeDefinition
{
