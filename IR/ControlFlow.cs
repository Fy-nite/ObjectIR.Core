...
[Obsolete("Use ASTNode equivalents instead.")]public sealed class IfInstruction : Instruction
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class WhileInstruction : Instruction
{
   public Condition Condition { get; set; }
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class TryInstruction : Instruction
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class CatchClause
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class ThrowInstruction : Instruction
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class StackCondition : Condition
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class BinaryCondition : Condition
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class ExpressionCondition : Condition
{
...
[Obsolete("Use ASTNode equivalents instead.")]public sealed class LogicalCondition : Condition
{
...
/// </summary>
[Obsolete("Use ASTNode equivalents instead.")]public sealed class ForEachInstruction : Instruction
{
